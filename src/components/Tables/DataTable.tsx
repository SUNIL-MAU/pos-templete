...
interface DataTableProps {
  ...
  defaultFields?: Partial<DataRow> | undefined // Add this prop
}

const DataTable: React.FC<DataTableProps> = ({ data, hiddenColumns = [], t ,isAccordion, defaultFields }) => {
  ...
  const handleAddClick = (row: DataRow) => {
    console.log(row)
    setCurrentMode('add');
    setCurrentData(defaultFields ?? {});
    setModalOpen(true);
  };
